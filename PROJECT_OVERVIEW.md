...
- The **source domain** has abundant component-level labels (`PCond`, `PSw`, `Pcore`, `PCopp`) and total loss (`PTotal`).
- The **target domain** has limited data with only total loss (`PTotal`).
␊
